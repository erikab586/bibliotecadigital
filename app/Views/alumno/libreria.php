                ...
                <div class="row">
                            ...
                            <div class="single-sidebar-widget">
                                ...
                                <div class="categories-list">
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        <?php foreach($carreras as $c): if($c['idarea']== session('idcarrera')):?>
                                        <li class="nav-item" role="presentation">
                                            <a href="<?=base_url('/todascarrera/').$c['idarea']?>" class="nav-link active" id="pills-arts-tab" >
                                                <?=$c['nombrearea']?>
                                            </a>
                                        </li>
                    ...
                    <div class="col-xl-9 col-lg-8 order-1 order-md-2">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                                        <div class="shop-box-items">
                                            <div class="book-thumb center">
                                                <a href="<?=base_url('/consulta/').$l->idlibros?>"><img src="<?=base_url($l->imagen)?>" alt="img"></a>
                        ...
                        <div class="page-nav-wrap text-center">
                            <ul>
                                <li><a class="previous" href="<?=base_url('/todascarrera/').$c['idarea']?>">Previous</a></li>
                                <li><a class="page-numbers" href="<?=base_url('/todascarrera/').$c['idarea']?>">1</a></li>
                                <li><a class="page-numbers" href="<?=base_url('/todascarrera/').$c['idarea']?>">2</a></li>
                                <li><a class="page-numbers" href="<?=base_url('/todascarrera/').$c['idarea']?>">3</a></li>
                                <li><a class="page-numbers" href="<?=base_url('/todascarrera/').$c['idarea']?>">...</a></li>
                                <li><a class="next" href="<?=base_url('/todascarrera/').$c['idarea']?>">Next</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
