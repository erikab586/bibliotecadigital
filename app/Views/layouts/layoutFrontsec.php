                                        ...
                                        <div class="main-menu">
                                            <nav>
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="<?=base_url('/libroscarreras')?>">Libros</a>
                                                    </li>
                                                    <li><i class="fa-light fa-user"></i>
                                                        <button data-bs-toggle="modal" data-bs-target="#loginModal">
                                                            Login
                                        ...
                                        <div class="main-menu">
                                            <nav id="mobile-menu">
                                                <ul>
                                                    ...
                                                    <li> 
                                                        <a href="<?=base_url('/libroscarreras')?>">Libro </a>
                                                    </li>
                                                    <li><i class="fa-light fa-user"></i>
                                                        <button data-bs-toggle="modal" data-bs-target="#loginModal">
                                                            Login
                ...
                <div class="modal-body">
                    ...
                    <div class="identityBox">
                        <div class="form-wrapper">
                            ...
                            <form id="login">
                                <input class="inputField" id="email" type="email" name="email" placeholder="Email">
                                <input class="inputField" id="password" type="password" name="password" placeholder="Password">
             ...
             document.getElementById('login').addEventListener('submit', function(e) {
                ...
                .then(data => {
                    if (data.status === 'success') {
                        Swal.fire('Bienvenido a nuestra Biblioteca Digital. ').then(() => {
                            window.location.href = '<?= base_url("/admbiblioteca") ?>';
                        });
                    } else {
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 ps-lg-5 wow fadeInUp" data-wow-delay=".4s">
                        <div class="single-footer-widget">
                            ...
                            <ul class="list-area">
                                ...
                                <li>
                                    <a href="<?=base_url('/libroscarreras')?>">
                                        <i class="fa-solid fa-chevrons-right"></i>
                                        Libros
                                    </a>
                                </li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 ps-lg-5 wow fadeInUp" data-wow-delay=".6s">
                        <div class="single-footer-widget">
                            ...
                            <ul class="list-area">
                                <li>
                                    <a href="<?=base_url('/librosderecho')?>">
                                        <i class="fa-solid fa-chevrons-right"></i>
                                        Licenciatura en Derecho
                                    </a>
                                </li>
                                <li>
                                    <a href="<?=base_url('/librosadministracion')?>">
                                        <i class="fa-solid fa-chevrons-right"></i>
                                        Licenciatura en Administración
                                    </a>
                                </li>
                                <li>
                                    <a href="<?=base_url('librospsicologia')?>">
                                        <i class="fa-solid fa-chevrons-right"></i>
