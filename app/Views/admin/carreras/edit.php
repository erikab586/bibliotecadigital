            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                    <div class="card">
                        <div class="header">
                            <h2>
                                EDITAR NUEVA CARRERA
                            </h2>
                        </div>
                        <div class="body">
                            <h2 class="card-inside-title">Llenar el formulario</h2>
                            <div class="row clearfix">
                                <form id="edicionCarreraForm">
                                    <div class="col-md-12">
                                        <p>
                                            <b>Nombre Area de Conocimiento</b>
                                        </p>
                                        <input type="hidden" name="id" value="<?=$carreras['idarea']?>">
                                        <div class="input-group input-group-lg">
                                            <span class="input-group-addon">
                                                <i class="material-icons">account_circle</i>
                                            </span>
                                            <div class="form-line">
                                                <input type="text" name="nombre" class="form-control" value="<?=$carreras['nombrearea']?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
...
<script>
    document.getElementById('edicionCarreraForm').addEventListener('submit', function(e) {
        e.preventDefault();

        const formData = new FormData(this);

        fetch('<?= base_url("/guardaredicionc") ?>', {
            method: 'POST',
            body: formData
        })
        ...
        .then(data => {
            if (data.status === 'success') {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'Hubo un problema al modificar la carrera',
                    confirmButtonText: 'OK',
                    width: '50vw',
                    padding: '3em',
                    customClass: {
