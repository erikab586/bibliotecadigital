...
<section class="content">
        ...
        <div class="block-header">
            ...
            <div class="block-header">
                <a href="<?= base_url('/crearcarreras')?>"  class="btn btn-primary btn-lg waves-effect">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $cont=1; foreach ($carreras as $i) : ?>
                                        <tr>
                                            <td><?= $cont++ ?></td>
                                            <td><?= $i['nombrearea'] ?></td>
                                            <td><?= $i['created_at'] ?></td>
                                            <td>
                                            <a class="btn btn-success waves-effect" href="<?php echo base_url('/editarcarreras')."/".$i['idarea']?>" title="Editar"> <i class="material-icons">create</i></a>
                                            <a class="btn btn-danger waves-effect" href="<?php echo base_url('/eliminarcarreras')."/".$i['idarea']?>" title="Eliminar"> <i class="material-icons">delete</i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
