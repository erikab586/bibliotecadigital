                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <form id="libroForm"  enctype="multipart/form-data">
                                    <div class="col-md-9">
                                        <p>
                                            <b>Código</b>
                                        </p>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="nombreautor" class="form-control" placeholder="Nombre del Autor">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="edicion" class="form-control" placeholder="Edición">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="anio" class="form-control" placeholder="Año de Publicación">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="lugar" class="form-control" placeholder="Lugar de Publicación">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <textarea type="text" name="sinopsis" row="5" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <textarea type="text" name="palabras" row="5" class="form-control" ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
