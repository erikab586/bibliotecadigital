...
<style>
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="block-header">
                <a href="<?= base_url('/crearroles')?>"  class="btn btn-primary btn-lg waves-effect">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $i['created_at'] ?></td>
                                            <td>
                                            <a class="btn btn-success waves-effect" href="<?php echo base_url('/editarroles')."/".$i['idrol']?>" title="Editar"> <i class="material-icons">create</i></a>
                                            <a class="btn btn-danger waves-effect" href="<?php echo base_url('/eliminar')."/".$i['idrol']?>" title="Eliminar"> <i class="material-icons">delete</i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
