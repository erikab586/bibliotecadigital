...
<section class="content">
        ...
        <div class="block-header">
            ...
            <div class="block-header">
                <a href="<?= base_url('/crearalumnos')?>"  class="btn btn-primary btn-lg waves-effect">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $cont=1; foreach ($alumnos as $i) : ?>
                                        <tr>
                                            <td><?= $cont++ ?></td>
                                            <td><?= $i->nombres." ". $i->apaterno." ". $i->amaterno ?></td>
                                            <td><?= $i->dni ?></td>
                                            <td><?= $i->matricula ?></td>
                                            <td><?= $i->email ?></td>
                                            <td><?= $i->ciclo ?></td>
                                            ...
                                            <td>
                                            <button class="btn btn-warning waves-effect" data-toggle="modal" data-target="#defaultModal" onclick="cambiarPassword(<?= $i->idalumno?>)"title="Cambiar Password"><i class="material-icons">cached</i></button>
                                            <a class="btn btn-success waves-effect" href="<?php echo base_url('/editaralumnos')."/".$i->idalumno?>" title="Editar"> <i class="material-icons">create</i></a>
                                            <a class="btn btn-danger waves-effect" href="<?php echo base_url('/eliminaralumnos')."/".$i->idalumno?>" title="Eliminar"> <i class="material-icons">delete</i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url('/guardarpassword')?>" method="POST">
