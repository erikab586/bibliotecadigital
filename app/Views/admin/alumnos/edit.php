                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <form id="edicionAlumnoForm">
                                    <input type="hidden" name="id" value="<?=$alumnos->idalumno?>">
                                    <div class="col-md-12">
                                        <p>
                                            <b>Nombres</b>
                                        </p>
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="nombre" class="form-control" value="<?=$alumnos->nombres?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="apellidopaterno" class="form-control" value="<?=$alumnos->apaterno?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="apellidomaterno" class="form-control" value="<?=$alumnos->amaterno?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="dni" class="form-control" value="<?=$alumnos->dni?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="matricula" class="form-control" value="<?=$alumnos->matricula?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="email" name="email" class="form-control" value="<?=$alumnos->email?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="ciclo" class="form-control" value="<?=$alumnos->ciclo?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <select name="rol" class="form-control show-tick" >
                                        <option value="<?=$alumnos->idrol?>"><?=$alumnos->nombrerol?></option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="carrera" class="form-control show-tick" >
                                            <option value="<?=$alumnos->idarea?>"><?=$alumnos->carrera?></option>
...
<script>
    document.getElementById('edicionAlumnoForm').addEventListener('submit', function(e) {
        e.preventDefault();

        const formData = new FormData(this);

        fetch('<?= base_url("/guardarediciona") ?>', {
            method: 'POST',
            body: formData
        })
        ...
        .then(data => {
            if (data.status === 'success') {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Error',
                    text: 'Hubo un problema al modificar el alumno',
                    confirmButtonText: 'OK',
                    width: '50vw',
                    padding: '3em',
                    customClass: {
